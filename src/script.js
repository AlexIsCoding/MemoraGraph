...
function displayContent(onlySettings) {
    ...
    const formDisplay = document.querySelector('.new-question-form');

    if (onlySettings == true) {
        // Only show settings
        cardDisplay.style.display = 'none';
        formDisplay.style.display = 'none';
        document.getElementById('session-storage-section').style.display = 'flex';
        return;

    }

    // whatever happens now, hide settings
    document.getElementById('session-storage-section').style.display = 'none';

    if (isCollectMode) {
        document.getElementById("page-mode").innerText = "Learn Questions"
        cardDisplay.style.display = 'none';
        formDisplay.style.display = 'block';
    } else {
        document.getElementById("page-mode").innerText = "Add Question"
